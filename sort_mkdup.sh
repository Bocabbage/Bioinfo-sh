...
gatk=/home/pgstu2/group2/gatk-4.0.11.0/gatk
...
$outdir/temp/KPGP-00001_L$i.hg19.sorted.bam \
...
$outdir/temp/KPGP-00001_L$i.hg19.sorted.bam -O \
$outdir/temp/KPGP-00001_L$i.hg19.sorted.markdup.bam -M \
$outdir/temp/KPGP-00001_L$i.hg19.sorted.markdup_metrics.txt
done

# 创建比对索引
for i in {1..6};do
time $samtools index $outdir/temp/KPGP-00001_L$i.hg19.sorted.markdup.bam
done
